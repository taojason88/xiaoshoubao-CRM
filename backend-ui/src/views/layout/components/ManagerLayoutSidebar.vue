<template>
  <div class="mother_land">
    <!-- <div class="nav-first-box"> -->
      ...
      <!-- ============================================================ -->
      <!-- <flexbox class="nav-items-first">
        <router-link
          v-for="(item, index) in items1"
          :style="{ 'color' : item.type == navIndexChild ? '#3E84E9' : '#FFFFFF' }"
          :to="item.path"
          :key="index"
          class="nav-item-first"
          @click.native="navItemsClick(item.type)"
        >
          <i :class="'wukong-' + item.icon" class="wukong" style="color:white" />
    ...
    <div class="container">
      ...
      <el-menu
        ...
        :style="{'border-right-color': backgroundColor, 'padding-top': createButtonTitle != '' ? '20px' : '20px'}"
      ...
      <!-- <div :style="{ 'background-color':backgroundColor }" class="sidebar-bottom">
...
export default {
  ...
  created() {
    this.navIndexChild = app.state.navbar.activeIndex;
  },
  methods: {
